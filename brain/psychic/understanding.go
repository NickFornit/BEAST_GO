...
//////////////////////////////////////
	...
	if isFirstActivation{// проснулся, получил InterruptMemory, первые мысли
	...
	}else{// при кадом крове первого вызове
		...
		if activationType==1 {// объективное восприятие
			getGreatestImportance()// выделить наиболее нзачимое в восприятии
			//curImportanceJbjectArr []int - здесь теперь - текущие цели внимания к наиболее важному
		}
