...
Значимости в коде проекта обычно имеют значения величин от -10 0 до 10,
но в случае значимости эффекта от реагирования от -1 0 до 1,
а в случаях усредненной значимости компонентов объекта Ответа
(акты воздействия, фразы и отдельные слова, принимающие значимость фразы)
не органичены в минус и плюс. В последнем случае такая значимость берется из Эффекта пробных действий
и связывается ос всеми компонентами воспринимаемого в этих условиях функцией setImportance().
...
type importance struct {
	...
	Value int // значимость от -N 0 до N Чудовищно большие будут говорить о сверх значимости.
}
